...
module RegisterFile(ReadRegister1, ReadRegister2, WriteRegister, WriteData, RegWrite, Clk, ReadData1, ReadData2, v0, v1, current_min_SAD);
	...
	output reg [31:0] v0, v1, current_min_SAD;
    ...
    for(i=0; i< 32; i= i+1)begin
        ...
        RegisterFile[29] <= 16384*4;
   end

//    always@(*) begin 
//    if (Clk == 1 && RegWrite == 1) begin 
...
//    end
	...
	always@(*) begin
	   ...
	   v1 <= RegisterFile[3];
	   v0 <= RegisterFile[2];
	   current_min_SAD <= RegisterFile[20];
	end
endmodule
